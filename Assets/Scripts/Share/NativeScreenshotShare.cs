...
public class NativeScreenshotShare : MonoBehaviour
{
    ...
    public void OnShareButtonClick()
    {
        ...
        shareSubject = "I challenge you to beat my high score in Dodgers";
        shareMessage = "I challenge you to beat my high score in Dodgers. " +
        ". Get the Dodgers app from the link below. \nCheers\n" +
        "\nhttp://playstore.in/games/dodgers";
    ...
    public IEnumerator ShareScreenshotInAnroid()
    {
        ...
        if (!Application.isEditor)
        {
            ...
            currentActivity.Call("startActivity", chooser,"Your New High Score");
        }
